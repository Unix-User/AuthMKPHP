...
const edit = (device) => {
    Object.assign(form.value, device);
    editMode.value = true;
    openModal();
};
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
                            Here you can manage the devices in the system. You can add new devices, edit existing information, or remove devices.
                        </p>
                    </div>

                    <div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 p-6 lg:p-8 space-y-6 md:space-y-0 md:grid md:grid-cols-2 md:gap-6 lg:gap-8">
                        <div>
                                ...
                                <div class="">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <TextInput id="ip" v-model="form.ip" type="text"
                                            :disabled="viewMode" class="mt-1 block w-full" autocomplete="ip" />
                                        <InputError :message="$page.props.errors.ip" class="mt-2" />
                                    </div>
                                    <div class="mb-4">
                                        <InputLabel for="team_id" value="Team ID" />
                                        <TextInput id="team_id" v-model="form.team_id" type="text"
                                            :disabled="viewMode" class="mt-1 block w-full" autocomplete="team_id" />
                                        <InputError :message="$page.props.errors.team_id" class="mt-2" />
                                    </div>
                                    <div class="mb-4">
                                        <InputLabel for="ikev2" value="IKEv2" />
                                        <TextInput id="ikev2" v-model="form.ikev2" type="text" :disabled="viewMode" class="mt-1 block w-full"
                                            autocomplete="ikev2" />
                                        <InputError :message="$page.props.errors.ikev2" class="mt-2" />
                                    </div>
                                    <div class="mb-4">
                                        <InputLabel for="user" value="User" />
                                        <TextInput id="user" v-model="form.user" type="text" :disabled="viewMode" class="mt-1 block w-full"
                                            autocomplete="user" />
