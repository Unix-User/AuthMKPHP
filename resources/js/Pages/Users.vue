                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div
                        ...
                        <p class="mt-6 text-gray-500 dark:text-gray-400 leading-relaxed">
                            Aqui você pode gerenciar os usuários do sistema. Você pode convidar novos usuários, editar informações existentes ou
                            remover usuários.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Clique no botão abaixo para convidar um novo usuário para o sistema.
                            </p>
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Abaixo está a lista de todos os usuários atualmente registrados no sistema.
                            </p>
                        </div>
                    </div>
